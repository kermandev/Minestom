...
public class PlayerBlockPlacementIntegrationTest {
    ...
    private static Stream<Arguments> placeBlockFromAdventureModeParams() {
        return Stream.of(
                ...
                Arguments.of(Block.ACACIA_STAIRS.withProperty("facing", "south"), new BlockPredicates(new BlockPredicate(RegistryTag.direct(Block.ACACIA_STAIRS.registryKey()), PropertiesPredicate.exact("facing", "south"), null))),
