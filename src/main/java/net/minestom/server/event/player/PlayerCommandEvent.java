 ...
 */
public value record PlayerCommandEvent(@NotNull Player player, @NotNull String command, boolean cancelled) implements PlayerInstanceEvent, CancellableEvent<PlayerCommandEvent> {
