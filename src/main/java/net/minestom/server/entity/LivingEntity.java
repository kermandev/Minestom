...
public class LivingEntity extends Entity implements EquipmentHandler {
    ...
    public void update(long time) {
        ...
        if (canPickupItem() && itemPickupCooldown.isReady(time)) {
            ...
            final EntitySelector<ItemEntity> itemSelector = EntitySelector.selector(ItemEntity.class, builder -> builder.gather(EntitySelector.Gather.range(expandedBoundingBox.width())));
