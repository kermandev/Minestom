...
public final class Server {
    ...
    private final PacketParser.Server packetWriter;
    ...
    public Server(PacketParser.Client packetParser, PacketParser.Server packetWriter) {
    ...
    @ApiStatus.Internal
    public PacketParser.Server packetWriter() {
        return packetWriter;
    }
