...
public record BuiltinSoundEvent(Key key, int id) implements StaticProtocolObject<BuiltinSoundEvent>, SoundEvent {
    static final Registry<BuiltinSoundEvent> REGISTRY = SoundEventValues.load(reinterpretKey());
    ...
    @SuppressWarnings("all")
    static @UnknownNullability BuiltinSoundEvent get(RegistryKey<? extends SoundEvent> key) {
